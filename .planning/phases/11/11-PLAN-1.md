...
- `[ ]` **Task 1.2: Location Tracker Hook**
...
- [ ] Manual test: Check-in -> Move 50m -> Wait 5 mins -> Verify breadcrumb in DB.
- [ ] Manager view: Open Live Map -> See agent marker -> Click for route.
- [ ] Verified on mobile viewport (DevTools & Browser).
