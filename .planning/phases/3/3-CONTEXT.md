...
1. **Attendance vs Continuous Logging:** The user explicitly stated: *"i dont need attendence punchin but instead i need 24/7 location logs. no attendence system or punchin or active session at all."* The traditional punch-in/punch-out concept has been completely removed from scope.
