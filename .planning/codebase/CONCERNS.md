...
- Cause: Cleanup of records older than 24 hours (`EOD Cleanup`) is only triggered reactively when an active employee triggers a new location ping _and_ no existing slab exists for the day.
