      ...
      <FeatureGate featureKey="dashboard">
        <div className="flex flex-col space-y-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {metrics.map((metric) => (
              <Card key={metric.label} className="border-none p-0">
          ...
          <div className="grid gap-6 md:grid-cols-7">
            <Card className="border-none md:col-span-4">
              <CardHeader>
            ...
            <Card className="bg-primary/5 flex flex-col items-center justify-center border-none p-8 text-center md:col-span-3">
