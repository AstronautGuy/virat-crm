import { varchar, boolean, integer, jsonb, timestamp, pgTableCreator } from "drizzle-orm/pg-core";
...
export const systemSettings = createTable("system_settings", {
  ...
  disabledFeaturesGlobal: jsonb("disabled_features_global").$type<string[]>().default([]).notNull(),
